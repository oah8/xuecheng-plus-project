...
//        ProcessBuilder builder = new ProcessBuilder();
//        builder.command("D:\\VSCode\\Microsoft VS Code\\Code.exe");
//        //将标准输入流和错误输入流合并，通过标准输入流程读取信息
//        builder.redirectErrorStream(true);
//        Process p = builder.start();

        //ffmpeg的路径
        String ffmpeg_path = "D:\\ffmpeg-6.0-lib\\bin\\ffmpeg.exe";//ffmpeg的安装位置
        //源avi视频的路径
        String video_path = "F:\\avi-demo\\2.avi";
        //转换后mp4文件的名称
        String mp4_name = "2.mp4";
        //转换后mp4文件的路径
        String mp4_path = "F:\\avi-demo\\2.mp4";
        //创建工具类对象
