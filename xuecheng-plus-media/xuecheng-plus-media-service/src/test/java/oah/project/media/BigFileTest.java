...
public class BigFileTest {
	...
	public void testChunk() throws IOException {
		...
		// 源文件
		File sourceFile = new File("D:\\acwing-test.mp4");
		// 分块文件存储路径
		String chunkFilePath = "D:\\chunk-test\\";
		// 分块文件大小
	...
	public void testMerge() throws IOException {
		// 块文件目录
		File chunkFolder = new File("D:/chunk-test/");
		// 源文件
		File sourceFile = new File("D:/acwing-test.mp4");

		// 合并后的文件
		File mergeFile = new File("D:/acwing-test_2.mp4");
